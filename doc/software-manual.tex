...
for the VVC project. It applies to version 20.1 of the software.
\end{abstract}
...
\begin{OptionTableNoShorthand}{Neural network post-filter activation}{tab:sei-nn-post-filter-activation}
  ...
  \\
  \Option{SEINNPostFilterActivationNumOutputEntries} &
  \Default{0} &
  Specifies the number of nnpfa_output_flag syntax elements present in the SEINNPostFilterActivationOutputFlag list.
  \\
